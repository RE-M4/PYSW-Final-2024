...
// put Paciente
  public putPaciente(pac: Paciente): Observable<any> {
    ...
    let body:any = JSON.stringify(pac);
    return this._http.put('http://localhost:3000/finalg5/paciente/' + pac._id, body, httpOptions);
  }
...
//borra un paciente
  public deletePaciente(id: String): Observable<any> {
    ...
    return this._http.delete('http://localhost:3000/finalg5/paciente/' + id, httpOptions);
  }
